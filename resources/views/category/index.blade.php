            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        <p class="text-lg font-bold">Category Data</p>
                        <p class="text-sm font-light text-gray-400">Cateogry Data on here, you available to added, edited or
                            deleted.
                        </p>
                    </div>
                            ...
                            <td class="p-4 text-end">
                                ...
                                <div class="dropdown dropdown-end ">
                                    ...
                                    <ul tabindex="0"
                                        ...
                                        <li class=""><a href="{{ route('category.edit', $data->id) }}"
